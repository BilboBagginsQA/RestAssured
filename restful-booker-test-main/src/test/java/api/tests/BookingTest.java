...
public class BookingTest extends BaseTest {
	...
	public void createBooking() throws Exception {
		...
		System.out.println("CREATE BOOKING REQUEST:"+requestBody);
	...
	public void getBooking() throws Exception {
		...
		createBookingRequest.setExpectedStatusCode(200);
		createBookingRequest.setRequestBody(requestBody);
		System.out.println("GET BOOKING REQUEST:"+requestBody);
		createBookingRequest.perform();
		...
		System.out.println(getBookingDetails.getFirstname());
		System.out.println(getBookingDetails.getLastname());
	...
	public void deleteBooking() throws Exception {
		...
		createBookingRequest.setExpectedStatusCode(200);
		createBookingRequest.setRequestBody(requestBody);
		System.out.println("DELETE BOOKING REQUEST:"+requestBody);
		createBookingRequest.perform();
